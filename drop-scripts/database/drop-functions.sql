...
drop function bank.insert_import_rule_gl_rules_assets;
drop function bank.insert_import_rule_gl_rules_liabilities;
drop function bank.insert_import_rule_gl_rules_equity;
