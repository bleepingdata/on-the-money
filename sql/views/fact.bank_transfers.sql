...
from books.general_ledger gl
    inner join books.account a_bank_transfers on gl.account_id = a_bank_transfers.account_id
    inner join books.general_ledger gl_other_party on gl.gl_grouping_id = gl_other_party.gl_grouping_id
        and gl_other_party.account_id <> gl.account_id
    inner join books.account a_other_party on gl_other_party.account_id = a_other_party.account_id
