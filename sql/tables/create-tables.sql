...
create table if not exists bank.debt_type
(
...
create table if not exists books.account_type
(
...
create table if not exists bank.account_debt_type
(
...
create table if not exists bank.bank_account_gl_account_link
(
...
create table if not exists bank.import_rule_type
(
...
create table if not exists bank.import_rule
(
...
create table if not exists bank.import_rule_fields_to_match
(
...
create table if not exists bank.import_rule_gl_matrix
(
...
create table if not exists load.anz_excel
(
...
create table if not exists load.anz_mortgage_excel
(
    line_id int8 generated by default as identity primary key,
    bank_account_number varchar(50) null,
    bank_account_friendly_name varchar(50) null,
...
create table if not exists load.ofx
(
    line_id int8 generated by default as identity primary key,
...
create table if not exists books.general_ledger
(
...
create table if not exists fact_tbl.account_summary_by_month
(
...
create table if not exists dimension.dates
(
