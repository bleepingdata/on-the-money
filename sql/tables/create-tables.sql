...
insert into bank.import_rule_type (import_rule_type_id, description, details)
	values (2, 'Loan Split', 'Splits the bank transaction to two accounts. Pays down a payables account to zero, and puts the remainder against the loan principle');
