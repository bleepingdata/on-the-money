...
-- ============================================================
-- Function : bank.insert_import_rule_gl_rules_transfer_in(varchar, varchar,
--              int2, varchar, boolean, varchar, varchar, varchar, varchar,
--              varchar, varchar, varchar, varchar, varchar)
-- ============================================================
-- Purpose  : Creates a complete inbound bank transfer import rule, including
--            the rule header, matching criteria, and a GL matrix entry that
--            debits the cash account and credits the bank transfer clearing account.
--
-- Parameters
--   s_cash_account                     (varchar) : GL description of the destination cash account to debit.
--   s_bank_transfer_account            (varchar) : GL description of the bank transfer clearing account to credit.
...
--
-- Usage
--   PERFORM bank.insert_import_rule_gl_rules_transfer_in(
--       s_cash_account                    := 'ANZ Savings',
--       s_bank_transfer_account           := 'Interbank Transfer Clearing',
--       s_other_party_bank_account_number := '01-0123-0123456-00'
--   );
--
-- Dependencies
