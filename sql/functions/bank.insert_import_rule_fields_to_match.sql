...
begin
	...
	insert into bank.import_rule_fields_to_match(import_rule_id, bank_account_id, type, other_party_bank_account_number, details, particulars, code, reference, ofx_name, ofx_memo, wildcard_field)
	 values (n_import_rule_id, n_bank_account_id, s_type, s_other_party_bank_account_number, s_details, s_particulars, s_code, s_reference, s_ofx_name, s_ofx_memo, s_wildcard_field);
