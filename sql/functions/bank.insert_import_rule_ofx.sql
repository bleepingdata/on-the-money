...
begin
	...
	insert into bank.import_rule (bank_account_id, account_id, other_party_account_id, type, ofx_name, ofx_memo)
		values (n_bank_account_id, n_account_id, n_other_party_account_id, s_type, s_ofx_name, s_ofx_memo)
