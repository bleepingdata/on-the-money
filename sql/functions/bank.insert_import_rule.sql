...
begin
	...
	insert into bank.import_rule (bank_account_id, other_party_account_id, type, other_party_bank_account_number, details, particulars, code, reference)
		values (n_bank_account_id, n_other_party_account_id, s_type, s_other_party_bank_account_number, s_details, s_particulars, s_code, s_reference)
